...
export class MenuSingleComponent implements OnInit {
  ...
  public addToCart() {
    ...
    if (this.menuItem.cartCount <= this.menuItem.availibilityCount) {
      ...
      this.snackBar.open('You can not add more items than available. In stock ' + this.menuItem.availibilityCount + ' items and you already added ' + this.menuItem.cartCount + ' item to your cart', '×', {
        panelClass: 'error',
