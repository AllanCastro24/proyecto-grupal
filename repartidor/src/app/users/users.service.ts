...
import { RestaurantService } from '../pages/restaurants/restaurant.service';
...
export class UsersService {
  ...
  async _login(res: any): Promise<boolean> {
    ...
    return res !== 'Usuario o contraseña incorrecto' && res.Activo === 'S' && employee !== 'No es empleado' && employee.ID_puesto == 5;
  }
