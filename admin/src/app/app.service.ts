...
export class AppService {
  ...
  public url2 = environment.url + 'https://tmp02.appsdev.cyou/proyecto-grupal-backend/';
  //public url3 = environment.url + 'http://localhost/Slim/slim2/'; 
  public URL = "http://localhost/Angular/";

  public url3 = environment.url + 'https://tmp02.appsdev.cyou/proyecto-grupal-backend/';
